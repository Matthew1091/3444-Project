...
import com.example.bulbbeats.AccessPointListAdapter;
import com.example.bulbbeats.HueSharedPreferences;
...
public class PHHomeActivity extends Activity implements OnItemClickListener {
    ...
    public static final String TAG = "BulbBeats";
